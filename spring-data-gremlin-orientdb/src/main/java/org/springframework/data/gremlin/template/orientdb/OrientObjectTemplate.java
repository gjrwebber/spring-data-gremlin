...
public class OrientObjectTemplate extends AbstractOrientOperations<Object> implements OrientObjectOperations {
    ...
    public OrientObjectTemplate(OrientDBGremlinGraphFactory dbf) {
        super(dbf);
    }

    @Override
    public OObjectDatabaseTx getObjectDatabase() {
        return (OObjectDatabaseTx) database();
    }
    ...
    /**
     @Override public <RET extends List<?>> RET query(OQuery<?> query, DetachMode detachMode, Object... args) {
     ...
     @Override public <RET> OObjectIteratorClass<RET> browseClass(Class<RET> iClusterClass) {
     return getObjectDatabase().browseClass(iClusterClass);
     }

     @Override public <RET> OObjectIteratorClass<RET> browseClass(Class<RET> iClusterClass, boolean iPolymorphic) {
     return getObjectDatabase().browseClass(iClusterClass, iPolymorphic);
     }

     @Override public <RET> OObjectIteratorClass<RET> browseClass(String iClassName) {
     return getObjectDatabase().browseClass(iClassName);
     }

     @Override public <RET> OObjectIteratorClass<RET> browseClass(String iClassName, boolean iPolymorphic) {
     ...
     @Override public ODatabaseInternal<?> setDatabaseOwner(ODatabaseInternal<?> iOwner) {
     return getObjectDatabase().setDatabaseOwner(iOwner);
     }

     @Override public <RET> OObjectIteratorCluster<RET> browseCluster(String iClusterName) {
     ...
     @Override public ODatabasePojoAbstract<Object> setRetainObjects(boolean iValue) {
     return getObjectDatabase().setRetainObjects(iValue);
     }

     @Override public void attach(Object iPojo) {
     getObjectDatabase().attach(iPojo);
     }

     @Override public <RET> RET attachAndSave(Object iPojo) {
     return getObjectDatabase().attachAndSave(iPojo);
     }

     @Override public boolean isRetainObjects() {
     return getObjectDatabase().isRetainObjects();
     }

     @Override public <RET> RET detach(Object iPojo) {
     return getObjectDatabase().detach(iPojo);
     }

     @Override public <RET> RET detach(Object iPojo, boolean returnNonProxiedInstance) {
     return getObjectDatabase().detach(iPojo, returnNonProxiedInstance);
     }

     @Override public boolean existsUserObjectByRID(ORID iRID) {
     return getObjectDatabase().existsUserObjectByRID(iRID);
     }

     @Override public ODocument getRecordById(ORID iRecordId) {
     return getObjectDatabase().getRecordById(iRecordId);
     }

     @Override public <RET> RET detachAll(Object iPojo, boolean returnNonProxiedInstance) {
     return getObjectDatabase().detachAll(iPojo, returnNonProxiedInstance);
     }

     @Override public boolean isManaged(Object iEntity) {
     return getObjectDatabase().isManaged(iEntity);
     }

     @Override public Object getUserObjectByRecord(OIdentifiable iRecord, String iFetchPlan) {
     return dbf.db().getUserObjectByRecord(iRecord, iFetchPlan);
     }

     @Override public long countClass(String className) {
     return getObjectDatabase().countClass(className);
     }

     @Override public long countClass(Class<?> clazz) {
     return getObjectDatabase().countClass(clazz);
     }

     @Override public OEntityManager getEntityManager() {
     return getObjectDatabase().getEntityManager();
     }

     @Override public ODatabaseDocument getUnderlying() {
     return getObjectDatabase().getUnderlying();
     }

     @Override public ORecordVersion getVersion(Object iPojo) {
     return getObjectDatabase().getVersion(iPojo);
     }

     @Override public ORID getIdentity(Object iPojo) {
     return getObjectDatabase().getIdentity(iPojo);
     }

     @Override public boolean isSaveOnlyDirty() {
     return getObjectDatabase().isSaveOnlyDirty();
     }

     @Override public void setSaveOnlyDirty(boolean saveOnlyDirty) {
     getObjectDatabase().setSaveOnlyDirty(saveOnlyDirty);
     }

     @Override public boolean isAutomaticSchemaGeneration() {
     return getObjectDatabase().isAutomaticSchemaGeneration();
     }

     @Override public void setAutomaticSchemaGeneration(boolean automaticSchemaGeneration) {
     getObjectDatabase().setAutomaticSchemaGeneration(automaticSchemaGeneration);
     }

     @Override public ODocument pojo2Stream(Object iPojo, ODocument iRecord) {
     return getObjectDatabase().pojo2Stream(iPojo, iRecord);
     }

     @Override public Object stream2pojo(ODocument iRecord, Object iPojo, String iFetchPlan) {
     return getObjectDatabase().stream2pojo(iRecord, iPojo, iFetchPlan);
     }

     @Override public Object stream2pojo(ODocument iRecord, Object iPojo, String iFetchPlan, boolean iReload) {
     return getObjectDatabase().stream2pojo(iRecord, iPojo, iFetchPlan, iReload);
     }

     @Override public boolean isLazyLoading() {
     return getObjectDatabase().isLazyLoading();
     }

     @Override public void setLazyLoading(boolean lazyLoading) {
     getObjectDatabase().setLazyLoading(lazyLoading);
     }

     @Override public void unregisterPojo(Object iObject, ODocument iRecord) {
     getObjectDatabase().unregisterPojo(iObject, iRecord);
     }

     @Override public void registerClassMethodFilter(Class<?> iClass, OObjectMethodFilter iMethodFilter) {
     getObjectDatabase().registerClassMethodFilter(iClass, iMethodFilter);
     }

     @Override public void deregisterClassMethodFilter(Class<?> iClass) {
     getObjectDatabase().deregisterClassMethodFilter(iClass);
     }

     @Override public <RET> RET queryForObject(OSQLQuery<?> query, Object... args) {
     List<RET> list = query(query, args);

     return list.isEmpty() ? null : list.get(0);
     }

     @Override public <RET> RET queryForObject(OSQLQuery<?> query, DetachMode detachMode, Object... args) {
     ...
     @Override public void registerEntityClass(Class<?> domainClass) {
